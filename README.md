...
![CI](https://github.com/Pratik-sanap/Carbon-Platform/actions/workflows/ci.yml/badge.svg)
...
👉 **[https://carbon-platform-777334451857.us-central1.run.app/](https://carbon-platform-777334451857.us-central1.run.app/)**
...
```bash
# 1. Clone the repo
git clone https://github.com/Pratik-sanap/Carbon-Platform.git
cd carbon-platform
...
# Authenticate
gcloud auth login
gcloud config set project week3-500021

# Build and push image
gcloud builds submit --tag gcr.io/week3-500021/carbon-platform .

# Deploy to Cloud Run
gcloud run deploy carbon-platform \
  --image gcr.io/week3-500021/carbon-platform \
  --region us-central1 \
  --platform managed \
  --allow-unauthenticated \
  --set-env-vars PROJECT_ID=week3-500021,REGION=us-central1,ENVIRONMENT=production
```
